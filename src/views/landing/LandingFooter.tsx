...
const LandingFooter = () => {
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-100 py-16 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          {/* Logo + tagline */}
          <div>
            <h2 className="text-2xl font-black heading-font tracking-tighter italic uppercase text-[#0F0F0F]">
              K-MIRROR <span className="text-[#FF4D8D] not-italic">AI</span>
            </h2>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 mt-3">
